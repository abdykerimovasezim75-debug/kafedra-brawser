...
QUESTIONS = {
    ...
    "translation": [
        ...
        {"id": 6, "text": "Какую роль выполняет компонент Encoder в архитектуре машинного перевода?", "variants": ["Формирует векторное представление исходного текста", "Генерирует слова на целевом языке", "Удаляет знаки препинания", "Считает метрику качества"], "correct": "Формирует векторное представление исходного текста"},
